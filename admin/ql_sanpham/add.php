            ...
            <div class="col-sm-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        ...
                        <form action="?act=them_sanpham" method="post" enctype="multipart/form-data" id="addProductForm">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="mota_sp" class="form-control" rows="4"></textarea>
                                <div class="text-danger" style="display:none;">Bạn chưa nhập mô tả sản phẩm</div>
                            </div> 

                            <br>
                            <button type="submit" name="add_sanpham" class="btn btn-primary">Thêm sản phẩm</button>
